...
- **Dokumentationspflicht**: CLAUDE.md wird nach jeder Änderung aktualisiert. Vor jeder Planung Status-Einträge aktiv gegen den Code verifizieren, nie blind der Doku vertrauen.
...
| Status       | Thema                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **erledigt** | Partnerships-Refactor: Rooms → persistente Partnerschaften, Gast-Zugang weg, Share-Codes mit Double-Opt-In, Apple Sign-In, Google Sign-In. Alle 11 Phasen abgeschlossen 2026-05-03. Backend: neues Schema (9 Tabellen), Services/Routes/Socket/Tests (136 Tests grün), APNs-Push für Request/Accepted, Rate-Limits, Share-Code-Generierung. Apple Sign-In (Phase 9) + Google Sign-In (Phase 10) live: `/api/auth/apple` + `/api/auth/google`. iOS: Models/Services/ViewModels/Views komplett umgebaut, AuthView mit Premium-Startscreen + Apple/Google-Dock. Deep Links `watchd://add/CODE` + Universal Links aktiv.                                                                                 |
