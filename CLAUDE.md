...
- **Testing**: Keines (bewusst für MVP, P2 Backlog)
...
├── index.ts              # Express bootstrap; Middleware; Route-Registrierung; /health
...
| Status | Thema |
|--------|-------|
| **offen** | Tests — Vitest + Supertest; Fokus: Auth (Token-Rotation, Theft Detection), Matchmaking, Room-Stack |
